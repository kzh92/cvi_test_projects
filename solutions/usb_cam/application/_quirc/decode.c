...
{
	quirc_decode_error_t err;
	struct datastream* ds = (struct datastream*)my_malloc(sizeof(struct datastream));
    ...
    {
        my_printf("_------   QUIRC_ERROR_INVALID_VERSION\n");
