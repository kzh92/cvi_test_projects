...
int LiveMnSE::dnn_dic_size()
{
	return 792992;
}

int LiveMnSE::dnn_mem_size()
{
	return 196624 + 393232 + 418192 + 110992;
}

int LiveMnSE::dnn_create(const char* fn, float rConfig, unsigned char* pMemBuf)
{
...
int LiveMnSE::dnn_create(unsigned char* pDicData, int nDicDataSize, float rConfig, unsigned char* pMemBuf)
{
	if (g_nEngineLoaded) return 0;
	...
	Conv_83 = (float*)(gdata + 201528); // [1728]
	Conv_83_bs = (float*)(gdata + 208440); // [192]
	Conv_85 = (float*)(gdata + 209208); // [18432]
	Conv_85_bs = (float*)(gdata + 282936); // [96]
	Conv_86 = (float*)(gdata + 283320); // [18432]
	Conv_86_bs = (float*)(gdata + 357048); // [192]
	Conv_89 = (float*)(gdata + 357816); // [1728]
	Conv_89_bs = (float*)(gdata + 364728); // [192]
	Conv_91 = (float*)(gdata + 365496); // [18432]
	Conv_91_bs = (float*)(gdata + 439224); // [96]
	Conv_93 = (float*)(gdata + 439608); // [18432]
	Conv_93_bs = (float*)(gdata + 513336); // [192]
	Conv_96 = (float*)(gdata + 514104); // [1728]
	Conv_96_bs = (float*)(gdata + 521016); // [192]
	Conv_98 = (float*)(gdata + 521784); // [18432]
	Conv_98_bs = (float*)(gdata + 595512); // [96]
	Conv_101 = (float*)(gdata + 595896); // [2304]
	Conv_101_bs = (float*)(gdata + 605112); // [24]
	Conv_103 = (float*)(gdata + 605208); // [2304]
	Conv_103_bs = (float*)(gdata + 614424); // [96]
	Conv_107 = (float*)(gdata + 614808); // [36864]
	Conv_107_bs = (float*)(gdata + 762264); // [384]
	Conv_109 = (float*)(gdata + 763800); // [6144]
	Conv_109_bs = (float*)(gdata + 788376); // [384]
	Gemm_116 = (float*)(gdata + 789912); // [768]
	Gemm_116_bs = (float*)(gdata + 792984); // [2]

	Gemm_116_bs_mem[0] = Gemm_116_bs[0];
	Gemm_116_bs_mem[1] = Gemm_116_bs[1];
	Gemm_116_bs = Gemm_116_bs_mem;
	Gemm_116_bs[1] += (rConfig - 75);
...
float* LiveMnSE::dnn_forward(unsigned char* in)
{
	...
	IF_FLAG_STOP; padding(mem_blk1, mem_blk2, 1);
	// save_bin(mem_blk2); // 85 
	IF_FLAG_STOP; convdw3x3s2_pack4_neon(mem_blk2, mem_blk0, 192, 3, 2, Conv_83, Conv_83_bs);
	// save_bin(mem_blk0); // 86 
	IF_FLAG_STOP; relu(mem_blk0);
	// save_bin(mem_blk0); // 87 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk0, mem_blk1, 96, 1, 1, Conv_85, Conv_85_bs, (float*)mem_blk2);
	// save_bin(mem_blk1); // 88 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk1, mem_blk0, 192, 1, 1, Conv_86, Conv_86_bs, (float*)mem_blk2);
	// save_bin(mem_blk0); // 89 
	IF_FLAG_STOP; relu(mem_blk0);
	// save_bin(mem_blk0); // 90 
	IF_FLAG_STOP; padding(mem_blk0, mem_blk3, 1);
	// save_bin(mem_blk3); // 91 
	IF_FLAG_STOP; convdw3x3s1_pack4_neon(mem_blk3, mem_blk2, 192, 3, 1, Conv_89, Conv_89_bs);
	// save_bin(mem_blk2); // 92 
	IF_FLAG_STOP; relu(mem_blk2);
	// save_bin(mem_blk2); // 93 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk2, mem_blk0, 96, 1, 1, Conv_91, Conv_91_bs, (float*)mem_blk3);
	// save_bin(mem_blk0); // 94 
	IF_FLAG_STOP; eltwise_sum_pack4_neon(mem_blk1, mem_blk0, mem_blk2);
	// save_bin(mem_blk2); // 95 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk2, mem_blk0, 192, 1, 1, Conv_93, Conv_93_bs, (float*)mem_blk1);
	// save_bin(mem_blk0); // 96 
	IF_FLAG_STOP; relu(mem_blk0);
	// save_bin(mem_blk0); // 97 
	IF_FLAG_STOP; padding(mem_blk0, mem_blk3, 1);
	// save_bin(mem_blk3); // 98 
	IF_FLAG_STOP; convdw3x3s1_pack4_neon(mem_blk3, mem_blk1, 192, 3, 1, Conv_96, Conv_96_bs);
	// save_bin(mem_blk1); // 99 
	IF_FLAG_STOP; relu(mem_blk1);
	// save_bin(mem_blk1); // 100 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk1, mem_blk0, 96, 1, 1, Conv_98, Conv_98_bs, (float*)mem_blk3);
	// save_bin(mem_blk0); // 101 
	IF_FLAG_STOP; pooling_global_aver_pack4_neon(mem_blk0, mem_blk1);
	// save_bin(mem_blk1); // 102 
	IF_FLAG_STOP; flatten(mem_blk1);
	// save_bin(mem_blk1); // 103 
	IF_FLAG_STOP; innerproduct(mem_blk1, mem_blk3, 24, Conv_101, Conv_101_bs);
	// save_bin(mem_blk3); // 104 
	IF_FLAG_STOP; relu(mem_blk3);
	// save_bin(mem_blk3); // 105 
	IF_FLAG_STOP; innerproduct(mem_blk3, mem_blk1, 96, Conv_103, Conv_103_bs);
	// save_bin(mem_blk1); // 106 
	IF_FLAG_STOP; sigmoid(mem_blk1);
	// save_bin(mem_blk1); // 107 
	IF_FLAG_STOP; flatten(mem_blk1);
	// save_bin(mem_blk1); // 108 
	IF_FLAG_STOP; multiply(mem_blk0, mem_blk1, mem_blk3);
	// save_bin(mem_blk3); // 109 
	IF_FLAG_STOP; eltwise_sum_pack4_neon(mem_blk2, mem_blk3, mem_blk0);
	// save_bin(mem_blk0); // 110 
	IF_FLAG_STOP; conv1x1s1_sgemm_pack4_neon(mem_blk0, mem_blk1, 384, 1, 1, Conv_107, Conv_107_bs, (float*)mem_blk2);
	// save_bin(mem_blk1); // 111 
	IF_FLAG_STOP; relu(mem_blk1);
	// save_bin(mem_blk1); // 112 
	IF_FLAG_STOP; convdw_gdc_pack4_neon(mem_blk1, mem_blk0, 384, 4, 1, Conv_109, Conv_109_bs);
	// save_bin(mem_blk0); // 113 
	IF_FLAG_STOP; flatten(mem_blk0);
	// save_bin(mem_blk0); // 114 
	IF_FLAG_STOP; innerproduct(mem_blk0, mem_blk1, 2, Gemm_116, Gemm_116_bs);
	// save_bin(mem_blk1); // 115 
	return (float*)mem_blk1->mem;
}
