...
LIBFOO_DLL_EXPORTED int     GetFaceMotion_Fast_fromTempBuffer(unsigned char* pbImage1, unsigned char* pbImage2, int nImageHeight, int nImageWidth, int nFaceLeft, int nFaceTop, int nFaceH, int nFaceW, int* pnXMotion, int* pnYMotion, unsigned char* pTempBuffer, unsigned char* pTempBuffer2);
