...
static void sc3336_linear_1296P30_init(VI_PIPE ViPipe)
{
	...
	sc3336_write_register(ViPipe, 0x3018,0x1a);
	sc3336_write_register(ViPipe, 0x3019,0x0e);
	sc3336_write_register(ViPipe, 0x301f,0x42);
	...
	sc3336_write_register(ViPipe, 0x36ec,0x0c);
	...
	sc3336_write_register(ViPipe, 0x440d,0x10);
	sc3336_write_register(ViPipe, 0x440e,0x01);
	sc3336_write_register(ViPipe, 0x4509,0x20);
	sc3336_write_register(ViPipe, 0x4819,0x0c);
	sc3336_write_register(ViPipe, 0x481b,0x07);
	sc3336_write_register(ViPipe, 0x481d,0x1b);
	sc3336_write_register(ViPipe, 0x481f,0x06);
	sc3336_write_register(ViPipe, 0x4821,0x0c);
	sc3336_write_register(ViPipe, 0x4823,0x07);
	sc3336_write_register(ViPipe, 0x4825,0x06);
	sc3336_write_register(ViPipe, 0x4827,0x06);
	sc3336_write_register(ViPipe, 0x4829,0x0b);
