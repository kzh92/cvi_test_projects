...
s_uf_part_info g_upg_list[] = {
    {"prim", 0x2E000, 0x001d6000, UF_PF_APP},
    // {"fip_fsbl.bin", 0x00000000, 0x0000c000, UF_PF_NORMAL},
    {"imtb", 0x0002c000, 0x00002000, UF_PF_NORMAL},
    {"wno.bin", 0x00204000 + FN_WNO_DICT_OFFSET, FN_WNO_DICT_SIZE_REAL, UF_PF_WEIGHT_CRYPT},
    {"detect.bin", 0x00204000 + FN_DETECT_DICT_OFFSET, FN_DETECT_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"dlamk.bin", 0x00204000 + FN_DLAMK_DICT_OFFSET, FN_DLAMK_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"a1.bin", 0x00204000 + FN_A1_DICT_OFFSET, FN_A1_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"b.bin", 0x00204000 + FN_B_DICT_OFFSET, FN_B_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"b2.bin", 0x00204000 + FN_B2_DICT_OFFSET, FN_B2_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"c.bin", 0x00204000 + FN_C_DICT_OFFSET, FN_C_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"detect_h.bin", 0x00204000 + FN_DETECT_H_DICT_OFFSET, FN_DETECT_H_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"dlamk_h.bin", 0x00204000 + FN_DLAMK_H_DICT_OFFSET, FN_DLAMK_H_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"wnh.bin", 0x00204000 + FN_WNOH_DICT_OFFSET, FN_WNOH_DICT_SIZE_REAL, UF_PF_WEIGHT_CRYPT},
    {"lh.bin", 0x00204000 + FN_H_LIVE_DICT_OFFSET, FN_H_LIVE_DICT_SIZE_REAL, UF_PF_NORMAL},
    {"face_ir.bin", 0x00204000 + FN_FACE_IR_BIN_OFFSET, FN_FACE_IR_BIN_SIZE_REAL, UF_PF_NORMAL},
    {"audiotest.pcm", 0x00204000 + FN_TESTAUDIO_PCM_OFFSET, FN_TESTAUDIO_PCM_SIZE_REAL, UF_PF_NORMAL},
    {"v1.0.0.1.bin", 0x00204000 + FN_ISP_IR_BIN_OFFSET, FN_ISP_IR_BIN_SIZE_REAL, UF_PF_NORMAL},
    {"", 0, 0, 0} //terminator
};
